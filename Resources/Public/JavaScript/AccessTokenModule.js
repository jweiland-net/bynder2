...
define(["exports", "TYPO3/CMS/Backend/Enum/Severity", "TYPO3/CMS/Backend/MultiStepWizard", "jquery"], function(exports, severity, multiStep, $) {
      ...
      $("." + triggerAccessTokenWizardButtonClass).on("click", function () {
        ...
        fetch(me.getCurrentUrlWithAdditionalParameters(additionalParameters.join('&')), {
          headers: {
            ...
            'ext-bynder2': 'getAuthorizationUrl'
          }
        }).then(response => {
        ...
        let itemname = $getAccessTokenButton.data("itemname").replace("accessToken", "url");
        ...
        multiStep.addSlide(
          "AppKeySecretForm",
          "Set Bynder client ID and client secret",
        ...
        multiStep.addSlide(
          "RequestAuthCode",
          "Use link to retrieve Bynder Auth Code",
  ...
  function getPanelWithAuthCodeLink()
  {
    return '<div class="panel panel-info">' +
      '  <div class="panel-heading">Authorize your Bynder App</div>' +
